...
const GmailModal: React.FC<GmailModalProps> = ({ isOpen, onClose }) => {
  const [zoom, setZoom] = useState(50);
  const [position, setPosition] = useState({ x: window.innerWidth - 950, y: 20 });
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        ...
        >
          <h3 className="text-sm font-semibold text-gray-800">Gmail</h3>
